// Source unique des matchups d'entraînement/éval (v3, 2026-07-06 : les 8 héros).
// Miroirs exclus (user 2026-07-05) : coût sans information d'équilibre inter-héros.
import type { HeroId } from '../types.js'

export const TRAINABLE_HEROES: HeroId[] = ['hh', 'bw', 'fm', 'rv', 'dr', 'th', 'sm', 'py']

// Entraînement : toutes les paires ordonnées (56) + chaque héros vs Naraxus (8) = 64.
