...
export function fullAbilityBoard(
  heroId: HeroId,
  dice: number[],
  oracleState: HHState | BWState | FMState | RVState | DRState | THState | SMState | PYState | DUState | SEState | MBState,
) {
  return heroId === 'hh'
              ...
              : heroId === 'py'
                ...
                : heroId === 'du'
                  ...
                  : heroId === 'se'
                    ...
                    : heroId === 'mb'
                      ? mbConfig.buildAbilityBoard(dice, oracleState as MBState)
